...
```json
{
    "Velopipe.filteredBarcodes": "s3://dp-lab-data/collaborators/pi/project/sample/..._dense.csv",
    ...
    "Velopipe.fullBarcodeWhitelist": "s3://seqc-public/barcodes/ten_x_v3/flat/3M-february-2018.txt",
    "Velopipe.alreadySortedBam": true
}
```

- `Velopipe.filteredBarcodes`: a file from which filtered barcodes will be extracted:
...
- `Velopipe.fullBarcodeWhitelist`: 10x official barcode whitelist:
